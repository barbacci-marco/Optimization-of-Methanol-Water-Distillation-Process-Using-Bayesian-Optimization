...
data = pd.read_csv('/Users/marcobarbacci/Y3 Labs BOPT /Year 3 distilattion optimisation/Simulated data code/distillation_generated_data.csv')
...
reflux_flow_rates_plot = np.linspace(
    data['Reflux Ratio'].min(),
    data['Reflux Ratio'].max(),
    200
)
